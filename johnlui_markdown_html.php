<link rel="stylesheet" type="text/css" href="<?php echo BLOG_URL; ?>content/plugins/johnlui_markdown/styles/font-awesome.css" />
...
<script type="text/javascript" src="<?php echo BLOG_URL; ?>content/plugins/johnlui_markdown/scripts/js/module.js"></script>
...
$(function() {
  ...
  for (var i = 0; i < editors.length; i++) {
    ...
    var editor = new Simditor({
      textarea: $('#'+editor),
      defaultImage: '<?php echo BLOG_URL; ?>content/plugins/johnlui_markdown/images/image.png',
      toolbar: [
        'title',
        'bold',
        'italic',
